            ...
            <div class="container">
                <div class="row services-sidebar">
                    <div class="col-md-9 services-content">
                        ...
                        <section class="services-vision content-sec" id="fin-sec">
                            <div class="chemicals">
                                <h2 class="chemicals-title color-title">FINANCIALS</h2>
                        ...
                        <section class="services-vision content-sec" id="annual-sec" style="display: none;">
                            <div class="chemicals">
                        ...
                        <section class="services-vision content-sec" id="shareholding-sec" style="display: none;">
                            <div class="chemicals">
                                ...
                                <h2 class="chemicals-title color-title">SHAREHOLDING PATTERN</h2>
                                <h4 class="chemicals-subtitle subtitle"> Uniquely transform premier infrastructures before functional metrics. Completely mesh sustainable leadership for economically sound sources. </h4>
                                <p> Distinctively fashion standardized communities vis-a-vis seamless applications. Authoritatively recaptiualize efficient supply chains without vertical initiatives. Progressively visualize strategic relationships with error-free processes. Credibly strategize fully tested outsourcing with functional e-markets. Dynamically evisculate user friendly architectures before cross-media experiences.</p>
                            </div>
                            <div class="row vision">
                                <div class="col-sm-6">
                                    ...
                                    <?php $z=0; foreach ($reports as $d){
                                    if($d->section == 'shareholding_pattern'){
                                        if(($z>0 && $z%2 == 0) || $z==1){?>
                                            </ul>
                                        </div>
                                        <div class="col-sm-6">
                        ...
                        <section class="services-vision content-sec" id="corp-sec" style="display: none;">
                            <div class="chemicals">
                                <h2 class="chemicals-title color-title">CORPORATE GOVERNANCE</h2>
                                <h4 class="chemicals-subtitle subtitle"> Uniquely transform premier infrastructures before functional metrics. Completely mesh sustainable leadership for economically sound sources. </h4>
                                <p> Distinctively fashion standardized communities vis-a-vis seamless applications. Authoritatively recaptiualize efficient supply chains without vertical initiatives. Progressively visualize strategic relationships with error-free processes. Credibly strategize fully tested outsourcing with functional e-markets. Dynamically evisculate user friendly architectures before cross-media experiences.</p>
                            </div>
                            <div class="row vision">
                                <div class="col-sm-6">
                                    ...
                                    <?php $z=0; foreach ($reports as $d){
                                    if($d->section == 'corporate_governance'){
                                        if(($z>0 && $z%2 == 0) || $z==1){?>
                                            </ul>
                                        </div>
                                        <div class="col-sm-6">
                        ...
                        <section class="services-vision content-sec" id="investg-sec" style="display: none;">
                            <div class="chemicals">
                                <h2 class="chemicals-title color-title">INVESTORS GRIEVENCES</h2>
                                <h4 class="chemicals-subtitle subtitle"> Uniquely transform premier infrastructures before functional metrics. Completely mesh sustainable leadership for economically sound sources. </h4>
                                <p> Distinctively fashion standardized communities vis-a-vis seamless applications. Authoritatively recaptiualize efficient supply chains without vertical initiatives. Progressively visualize strategic relationships with error-free processes. Credibly strategize fully tested outsourcing with functional e-markets. Dynamically evisculate user friendly architectures before cross-media experiences.</p>
                            </div>
                            <div class="row vision">
                                <div class="col-sm-6">
                                    ...
                                    <?php $z=0; foreach ($reports as $d){
                                    if($d->section == 'investors_grievances'){
                                        if(($z>0 && $z%2 == 0) || $z==1){?>
                                            </ul>
                                        </div>
                                        <div class="col-sm-6">
                        ...
                        <section class="services-vision content-sec" id="announce-sec" style="display: none;">
                            <div class="chemicals">
                                <h2 class="chemicals-title color-title">ANNOUNCEMENTS / NOTICE</h2>
                                <h4 class="chemicals-subtitle subtitle"> Uniquely transform premier infrastructures before functional metrics. Completely mesh sustainable leadership for economically sound sources. </h4>
                                <p> Distinctively fashion standardized communities vis-a-vis seamless applications. Authoritatively recaptiualize efficient supply chains without vertical initiatives. Progressively visualize strategic relationships with error-free processes. Credibly strategize fully tested outsourcing with functional e-markets. Dynamically evisculate user friendly architectures before cross-media experiences.</p>
                            </div>
                            <div class="row vision">
                        ...
                        <section class="services-vision content-sec" id="investc-sec" style="display: none;">
                            <div class="chemicals">
                                <h2 class="chemicals-title color-title">INVESTORS CONTACT</h2>
                                <h4 class="chemicals-subtitle subtitle"> Uniquely transform premier infrastructures before functional metrics. Completely mesh sustainable leadership for economically sound sources. </h4>
                                <p> Distinctively fashion standardized communities vis-a-vis seamless applications. Authoritatively recaptiualize efficient supply chains without vertical initiatives. Progressively visualize strategic relationships with error-free processes. Credibly strategize fully tested outsourcing with functional e-markets. Dynamically evisculate user friendly architectures before cross-media experiences.</p>
                            </div>
                        ...
                        <section class="services-vision content-sec" id="policies-sec" style="display: none;">
                            <div class="chemicals">
                                <h2 class="chemicals-title color-title">POLICIES </h2>
                                <h4 class="chemicals-subtitle subtitle"> Uniquely transform premier infrastructures before functional metrics. Completely mesh sustainable leadership for economically sound sources. </h4>
                                <p> Distinctively fashion standardized communities vis-a-vis seamless applications. Authoritatively recaptiualize efficient supply chains without vertical initiatives. Progressively visualize strategic relationships with error-free processes. Credibly strategize fully tested outsourcing with functional e-markets. Dynamically evisculate user friendly architectures before cross-media experiences.</p>
                            </div>
                            <div class="row vision">
                        ...
                        <section class="services-vision content-sec" id="disclosure-sec" style="display: none;">
                            <div class="chemicals">
                                <h2 class="chemicals-title color-title">DISCLOSURE OF RELATED PARTY TRANSACTION</h2>
                                <h4 class="chemicals-subtitle subtitle"> Uniquely transform premier infrastructures before functional metrics. Completely mesh sustainable leadership for economically sound sources. </h4>
                                <p> Distinctively fashion standardized communities vis-a-vis seamless applications. Authoritatively recaptiualize efficient supply chains without vertical initiatives. Progressively visualize strategic relationships with error-free processes. Credibly strategize fully tested outsourcing with functional e-markets. Dynamically evisculate user friendly architectures before cross-media experiences.</p>
                            </div>
                            <div class="row vision">
                                <div class="col-sm-6">
                                    ...
                                    <?php $z=0; foreach ($reports as $d){
                                    if($d->section == 'disclosure_of_txn'){
                                        if(($z>0 && $z%2 == 0) || $z==1){?>
                                            </ul>
                                        </div>
                                        <div class="col-sm-6">
                    ...
                    <div class="col-md-3 sidebar left">
                        ...
                        <div class="sidebar-blog-categories">
                            <ul>
                                <li> <a data-section = "fin-sec" class="side-link active" href="javascript:;"> Financials </a> </li>
                                <li> <a data-section = "annual-sec" class="side-link" href="javascript:;"> Annual Reports </a> </li>
                                <li> <a data-section = "shareholding-sec" class="side-link" href="javascript:;"> Shareholding Pattern</a> </li>
                                <li> <a data-section = "corp-sec" class="side-link" href="javascript:;"> Corporate Governance</a> </li>
                                <li> <a data-section = "investg-sec" class="side-link" href="javascript:;"> Investors Grievances</a> </li>
                                <li> <a data-section = "announce-sec" class="side-link" href="javascript:;"> Announcements/Notices</a> </li>
                                <li> <a data-section = "investc-sec" class="side-link" href="javascript:;"> Investor's Contact</a> </li>
                                <li> <a data-section = "policies-sec" class="side-link" href="javascript:;"> Policies </a> </li>
                                <li> <a data-section = "disclosure-sec" class="side-link" href="javascript:;">Disclosure of Related Party Transaction </a> </li>
                            </ul>
                        </div>
