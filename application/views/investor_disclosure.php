                ...
                <div class="row services-sidebar">
                    <div class="col-md-9 services-content">
                        ...
                        <section class="services-vision content-sec" id="annual-sec" style="display: none;">
                            <div class="chemicals">
                                ...
                                <h2 class="chemicals-title color-title">ANNUAL RETURN</h2>
                                <!-- <h4 class="chemicals-subtitle subtitle"> Uniquely transform premier infrastructures before functional metrics. Completely mesh sustainable leadership for economically sound sources. </h4>
                                <p> Distinctively fashion standardized communities vis-a-vis seamless applications. Authoritatively recaptiualize efficient supply chains without vertical initiatives. Progressively visualize strategic relationships with error-free processes. Credibly strategize fully tested outsourcing with functional e-markets. Dynamically evisculate user friendly architectures before cross-media experiences.</p> -->
                            </div>
                    ...
                    <div class="col-md-3 sidebar left">
                        ...
                        <div class="sidebar-blog-categories">
                            <ul>
                                <li> <a data-section = "shareholding-sec" class="side-link active" href="javascript:;"> Shareholding Pattern</a> </li>
                                <li> <a data-section = "corp-sec" class="side-link" href="javascript:;"> Corporate Governance Report</a> </li>
                                <li> <a data-section = "fin-sec" class="side-link" href="javascript:;"> Annual Secretarial Compliance Report </a> </li>
                                <li> <a data-section = "policies-sec" class="side-link" href="javascript:;"> Reconciliation of share capital audit report </a> </li>
                                <li> <a data-section = "annual-sec" class="side-link" href="javascript:;"> Annual Return </a> </li>
                                <li> <a data-section = "investg-sec" class="side-link" href="javascript:;"> General meetings/Postal Ballots</a> </li>
                                <li> <a data-section = "announce-sec" class="side-link" href="javascript:;"> News Paper Publication</a> </li> 
                                <li> <a data-section = "disclosure-sec" class="side-link" href="javascript:;">Other Disclosures</a> </li>
                            </ul>
                        </div>
